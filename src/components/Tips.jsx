...
const Tips = () => {
  return (
    <section id="dicas" className="py-24 px-4 bg-white relative overflow-hidden">
      {/* Decorative Flowers */}
      <div className="absolute -left-20 -bottom-20 w-64 h-64 opacity-15 pointer-events-none transform -rotate-12 z-0">
        <img src={flowers} alt="" className="w-full h-full object-contain" />
      </div>
      <div className="absolute -right-20 -top-20 w-64 h-64 opacity-15 pointer-events-none transform rotate-45 z-0">
        <img src={flowers} alt="" className="w-full h-full object-contain" />
      </div>
